...
export const LandingSearch = () => {
  ...
  const handleSearch = (e: React.FormEvent) => {
    ...
    if (username.includes("audiox-omega.vercel.app/u/")) {
      username = username.split("audiox-omega.vercel.app/u/")[1];
