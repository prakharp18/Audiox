...
import { Link01Icon as LinkIcon, AlertCircleIcon as AlertCircle } from "hugeicons-react"; // Fallback/Mix
import { 
  Loader2, 
  Send, 
  Sparkles, 
  ...
  return (
    <main className="min-h-screen w-full bg-black text-white flex flex-col items-center justify-center p-4 relative overflow-y-auto overflow-x-hidden font-sans">
      ...
      <div className="absolute top-6 right-6 z-50 flex items-center gap-4">
        ...
        <div className="flex items-center gap-2 bg-zinc-900/50 border border-zinc-800 px-3 py-1.5 rounded-full backdrop-blur-md">
          <div className={cn(
            ...
            isCheckingSystem ? "bg-yellow-500 shadow-yellow-500/50" : isSystemOnline ? "bg-green-500 shadow-green-500/50" : "bg-red-500 shadow-red-500/50"
          )} />
          <span className="text-[10px] uppercase font-mono tracking-widest text-zinc-400">
            {isCheckingSystem ? "SYSTEM CHECK..." : isSystemOnline ? "SYSTEM ONLINE" : "SYSTEM OFFLINE"}
          </span>
        </div>
      </div>

      <div className="relative z-10 w-full max-w-5xl grid grid-cols-1 md:grid-cols-12 gap-4 h-auto mt-20 md:mt-0 mb-20 md:mb-0">
        
        <div className="md:col-span-7 flex flex-col gap-4 h-full">
          
          <div className="bg-zinc-950 border border-zinc-800 rounded-2xl p-6 flex flex-col justify-center min-h-[120px]">
            <h1 className="text-3xl font-bold tracking-tight text-white flex items-center gap-3">
              AUDIOX <span className="text-zinc-600 font-mono text-lg font-normal">/ PUBLIC</span>
            </h1>
            <div className="flex items-center gap-3 mt-2">
              ...
              {isAcceptingMessages ? (
                <span className="inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-medium bg-emerald-500/10 text-emerald-500 border border-emerald-500/20 uppercase tracking-wide">
                  Accepting Messages
                </span>
              ) : (
                <span className="inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-medium bg-red-500/10 text-red-500 border border-red-500/20 uppercase tracking-wide">
                  Offline
                </span>
              )}
            </div>
          ...
          <div className="bg-zinc-950 border border-zinc-800 rounded-2xl p-8 flex-1 shadow-2xl flex flex-col relative overflow-hidden min-h-[450px]">
      ...
      <footer className="absolute bottom-4 z-50 flex items-center justify-center w-full pointer-events-none md:fixed md:bottom-8 px-4">
        <div className="pointer-events-auto flex items-center bg-zinc-950 border border-zinc-800 rounded-full pl-4 pr-6 h-12 gap-4 shadow-2xl overflow-x-auto max-w-[90vw] md:max-w-none no-scrollbar">
          
          <div className="flex items-center justify-center w-8 h-8 rounded-full bg-zinc-900 border border-zinc-800 text-[10px] font-black tracking-tighter text-zinc-400 ml-1">
            A
          </div>
          ...
          <div className="flex items-center gap-5">
            ...
            >
              ...
              <span className="text-xs text-zinc-200 font-bold leading-none flex items-center gap-1.5 group-hover:text-white transition-colors">
            ...
            <a
              href="http://vox-omega.vercel.app/"
              target="_blank"
              rel="noopener noreferrer"
              className="flex flex-col items-start justify-center group"
            >
            ...
            <div className="flex flex-col items-start justify-center">
              ...
              <span className="text-xs text-emerald-400 font-bold leading-none flex items-center gap-1.5">
